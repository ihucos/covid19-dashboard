...
build/graphdata.jsonnet: insights.py build/rki.csv build/hopkins.csv build/population.csv build/rki_age.csv build/hopkins_series_deaths.csv build/stock_germany.csv
